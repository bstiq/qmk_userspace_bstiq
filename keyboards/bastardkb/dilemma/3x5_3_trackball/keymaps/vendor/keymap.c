...
/** \brief Mouse emulation and pointer functions. */
  [LAYER_POINTER] = LAYOUT_split_3x5_3(
    QK_BOOT,  EE_CLR, XXXXXXX, DPI_MOD, S_D_MOD, S_D_MOD, DPI_MOD, PHIST,  EE_CLR, QK_BOOT,
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, PTABS, PBRIGHT, PZOOM, PVOLUME, PCUSTOM1,
    _______, DRGSCRL, SNIPING, MS_BTN3, XXXXXXX, XXXXXXX, CURSOR, SNIPING, DRGSCRL, _______,
 ...
 * `KC_RPRN`.
 */
 // TODO remove momentary layer tests
  [LAYER_SYMBOLS] = LAYOUT_split_3x5_3(
    MOE(1),LME(1, MOD_LSFT), KC_ASTR, KC_LPRN, KC_RCBR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
